...
const PROJECT_SASS_SRC = "./src/assets/scss/uswds";

// Project Sass source directory
const APPLICATION_SASS_SRC = "./src/assets/scss/application";

// Images destination
const IMG_DEST = "./src/assets/img";
...
const CSS_DEST = "./src/assets/stylesheets";

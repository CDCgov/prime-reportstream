...
############### Ordering facility info
    ...
    - name: ordering_facility_name
      ...
      csvFields: [{name: ordering_facility_name}]
      mapperOverridesValue: true
      mapper: ifNotPresent($mode:lookup, testing_lab_name, ordering_facility_name_temp, ordering_facility_street_temp)

    - name: ordering_facility_street
      cardinality: ONE 
      csvFields: [{name: ordering_facility_street}]
      mapperOverridesValue: true
      mapper: ifNotPresent($mode:lookup, testing_lab_street, ordering_facility_name_temp, ordering_facility_street_temp)
...
#      csvFields: [{name: ordering_facility_street2}]
    ...
    - name: ordering_facility_street2
      csvFields: [{name: ordering_facility_street2}]
      mapperOverridesValue: true
      mapper: ifNotPresent($mode:lookup, testing_lab_street2, ordering_facility_name_temp, ordering_facility_street_temp)

    - name: ordering_facility_city
      cardinality: ONE 
      csvFields: [{name: ordering_facility_city}]
      mapperOverridesValue: true
      mapper: ifNotPresent($mode:lookup, testing_lab_city, ordering_facility_name_temp,ordering_facility_street_temp)

    - name: ordering_facility_state
      cardinality: ONE 
      csvFields: [{name: ordering_facility_state}]
      mapperOverridesValue: true
      mapper: ifNotPresent($mode:lookup, testing_lab_state, ordering_facility_name_temp, ordering_facility_street_temp)

    - name: ordering_facility_zip_code
      cardinality: ONE 
      csvFields: [{name: ordering_facility_zip_code}]
      mapperOverridesValue: true
      mapper: ifNotPresent($mode:lookup, testing_lab_zip_code, ordering_facility_name_temp, ordering_facility_street_temp)

    - name: ordering_facility_phone_number
      cardinality: ONE 
      csvFields: [{name: ordering_facility_phone_number}]
      mapperOverridesValue: true
      mapper: ifNotPresent($mode:lookup, testing_lab_phone_number, ordering_facility_name_temp, ordering_facility_street_temp)

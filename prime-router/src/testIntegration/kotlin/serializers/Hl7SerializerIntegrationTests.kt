...
NTE|1|L|This is a final comment|RE"""
    ...
    fun `test cliaForOutOfStateTesting`() {
        ...
        // SenderID is set to "fake" in this CSV
        val csvContentFacilityState = ByteArrayInputStream(csvCompleteFacilityState.toByteArray())

...
class ORCOBRToServiceRequestDiagnosticReportTests {
    ...
    fun `test OBR populated`() {
        val testFileName = "orcobr/orc_obr-to-servicerequest_diagnosticreport-obr-populated"
        assert(verifyHL7ToFHIRToHL7Mapping(testFileName).passed)
    }
    ...
    fun `test prefers ORC for identifiers`() {
        val testFileName = "orcobr/orc_obr-to-servicerequest_diagnosticreport-prefers-orc-for-identifiers"
        assert(verifyHL7ToFHIRToHL7Mapping(testFileName).passed)
    }
    ...
    fun `test prefers ORC12 for the requester`() {
        val testFileName = "orcobr/orc_obr-to-servicerequest_diagnosticreport-prefers-orc-12-for-requester"
        assert(verifyHL7ToFHIRToHL7Mapping(testFileName).passed)
    }
    ...
    fun `test will create a practitioner only when ORC21, ORC22, ORC23 are not populated`() {
        val missingOrc212223 =
            "orcobr/orc_obr-to-servicerequest_diagnosticreport-requester-practitioner-missing-orc212223"
        assert(verifyHL7ToFHIRToHL7Mapping(missingOrc212223).passed)
        val orc21 =
            "orcobr/orc_obr-to-servicerequest_diagnosticreport-requester-practitionerrole-orc21-populated"
        assert(verifyHL7ToFHIRToHL7Mapping(orc21).passed)
        val orc22 =
            "orcobr/orc_obr-to-servicerequest_diagnosticreport-requester-practitionerrole-orc22-populated"
        assert(verifyHL7ToFHIRToHL7Mapping(orc22).passed)
        val orc23 =
            "orcobr/orc_obr-to-servicerequest_diagnosticreport-requester-practitionerrole-orc23-populated"
        assert(verifyHL7ToFHIRToHL7Mapping(orc23).passed)
    }

    @Test
    fun `test correctly handles the effective when OBR8 is not populated`() {
        val testFileName = "orcobr/orc_obr-to-servicerequest_diagnosticreport-obr8-not-populated"
        assert(verifyHL7ToFHIRToHL7Mapping(testFileName).passed)
    }
}
...
class FHIRtoHL7Tests : Logging {
    ...
    fun `parse fhir path`() {
        ...
        testCases.forEach { case ->
            assertThat(case.resource.getValue(case.path).first().toString()).isEqualTo("bar")
        }
    }

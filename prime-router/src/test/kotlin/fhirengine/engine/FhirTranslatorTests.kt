...
private const val ORU_R01_SCHEMA = "classpath:/hl7_mapping/receivers/STLTs/CA/CA-receiver-transform"
...
//                "/src/test/resources/enrichments/testing2"
    ...
    fun `test getByteArrayFromBundle`() {
        ...
        val fhirReceiver = Receiver(
            ...
            "fhir_transforms/receivers/fhir-transform-sample", format = Report.Format.FHIR,
        )

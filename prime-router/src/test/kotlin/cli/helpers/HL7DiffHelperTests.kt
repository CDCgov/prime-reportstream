...
class HL7DiffHelperTests {
    ...
    fun `diff hl7`() {
        ...
        val originalMessage = "MSH|^~\\&|STARLIMS.CDC.Stag^2.16.840.1.114222.4.3.3.2.1.2^ISO|CDC Atlanta^11D0668319^" +
            ...
            "Adobe_Code^Wound||||56459004^Foot^SCT^FOT^Foot^L^09012017^Adobe_Code^Foot||||||Isolate,|||" +
            "20230322|20230421124150\n"
        val comparisonMessage = "MSH|^~\\&|STARLIMS.CDC.Stag^2.16.840.1.114222.4.3.3.2.1.2^ISO|CDC Atlanta^" +
        ...
        assertThat(differences.size).isEqualTo(13)
        val differences2 = hL7DiffHelper.diffHl7(outputMessage[0], inputMessage[0])
        assertThat(differences2.size).isEqualTo(13)
    }
}
...
NTE|1|L|This is a final comment|RE"""
    ...
    fun `test cliaForSender`() {
        val cliaForSender = mapOf("fakeSender" to "ABCTEXT123", "simple_report.default" to "10D1234567")
        val hl7Config = mockkClass(Hl7Configuration::class).also {

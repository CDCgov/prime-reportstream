...
OBX|1|CWE|67704-7^Feeding types^LN||LA16915-3^Lactose formula^LN||||||F|||20231130123326
    ...
    fun `cryptography test`() {
        // Given password
        val password = "U6sIHmHpRl/gJaTe5elMXb5eKy1cGgUX25oY+Ui6wi8="

        // Encrypt the testPlainText to cipherText and check to make sure they are not equal
        val enKey = crypto.getAESKeyFromPassword(password.toCharArray())
        ...
        val deKey = crypto.getAESKeyFromPassword(password.toCharArray())

...
class RouterCli :
    ...
    override fun help(context: Context): String = "Tools and commands that support the PRIME Data Hub."
...
class ListSchemas :
    ...
    override fun help(context: Context): String = "list known schemas, senders, and receivers"

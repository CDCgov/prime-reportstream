...
abstract class ReportPipelineMessage : WithDownloadableReport, ReportIdentification, QueueMessage()
...
interface IdentifyNextAction {
    val nextAction: Event.EventAction
}
...
data class BatchEventQueueMessage(
    ...
    val at: String,
) : IdentifyNextAction, QueueMessage()

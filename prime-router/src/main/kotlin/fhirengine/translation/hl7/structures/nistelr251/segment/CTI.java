...
import fhirengine.translation.hl7.structures.nistelr251.datatype.CE;
import fhirengine.translation.hl7.structures.nistelr251.datatype.EI;
...
public class CTI extends AbstractSegment {
  ...
  private void init(ModelClassFactory factory) {
    try {
      ...
      this.add(CE.class, false, 1, 0, new Object[]{getMessage()}, "Study Phase Identifier");
      this.add(CE.class, false, 1, 0, new Object[]{getMessage()}, "Study Scheduled Time Point");

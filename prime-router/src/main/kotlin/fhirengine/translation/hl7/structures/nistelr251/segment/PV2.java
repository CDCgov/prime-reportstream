...
public class PV2 extends AbstractSegment {
  ...
  private void init(ModelClassFactory factory) {
    try {
      this.add(PL.class, false, 0, 0, new Object[]{getMessage()}, "Prior Pending Location");
      this.add(CWE.class, false, 0, 0, new Object[]{getMessage()}, "Accommodation Code");
      ...
      this.add(NM.class, false, 0, 0, new Object[]{getMessage()}, "Actual Length of Inpatient Stay");

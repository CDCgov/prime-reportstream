 ...
 * <ul>
     ...
     * <li>OBX-20: Reserved for harmonization with V2.6 ((TBD)) <b>optional repeating</b>
     * <li>OBX-21: Reserved for harmonization with V2.6 ((TBD)) <b>optional repeating</b>
     * <li>OBX-22: Reserved for harmonization with V2.6 ((TBD)) <b>optional repeating</b>
...
public class OBX extends AbstractSegment {
    ...
    /**
     * Returns a count of the current number of repetitions of Reserved for harmonization with V2.6 (OBX-20).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getReservedForHarmonizationWithV26Reps() {
     ...
     * @param rep The repetition index (0-indexed)
     */
    public (TBD) getReservedForHarmonizationWithV26(int rep) { 
		(TBD) retVal = this.getTypedField(20, rep);
		return retVal;
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public (TBD) getObx20_ReservedForHarmonizationWithV26(int rep) { 
		(TBD) retVal = this.getTypedField(20, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getObx20_ReservedForHarmonizationWithV26Reps() {
    	return this.getReps(20);
    }
    ...
    /**
     * Inserts a repetition of
     * OBX-20: "Reserved for harmonization with V2.6" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public (TBD) insertReservedForHarmonizationWithV26(int rep) throws HL7Exception { 
        return ((TBD)) super.insertRepetition(20, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public (TBD) insertObx20_ReservedForHarmonizationWithV26(int rep) throws HL7Exception { 
        return ((TBD)) super.insertRepetition(20, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public (TBD) removeReservedForHarmonizationWithV26(int rep) throws HL7Exception { 
        return ((TBD)) super.removeRepetition(20, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public (TBD) removeObx20_ReservedForHarmonizationWithV26(int rep) throws HL7Exception { 
        return ((TBD)) super.removeRepetition(20, rep);
    }
    ...
    /**
     * Returns a count of the current number of repetitions of Reserved for harmonization with V2.6 (OBX-21).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getReservedForHarmonizationWithV26Reps() {
    ...
    /**
     * Returns a specific repetition of
     * OBX-21: "Reserved for harmonization with V2.6" - creates it if necessary
     *
     * @param rep The repetition index (0-indexed)
     */
    public (TBD) getReservedForHarmonizationWithV26(int rep) { 
		(TBD) retVal = this.getTypedField(21, rep);
		return retVal;
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public (TBD) getObx21_ReservedForHarmonizationWithV26(int rep) { 
		(TBD) retVal = this.getTypedField(21, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getObx21_ReservedForHarmonizationWithV26Reps() {
    	return this.getReps(21);
    }
    ...
    /**
     * Inserts a repetition of
     * OBX-21: "Reserved for harmonization with V2.6" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public (TBD) insertReservedForHarmonizationWithV26(int rep) throws HL7Exception { 
        return ((TBD)) super.insertRepetition(21, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public (TBD) insertObx21_ReservedForHarmonizationWithV26(int rep) throws HL7Exception { 
        return ((TBD)) super.insertRepetition(21, rep);
    }
     ...
     */
    public (TBD) removeReservedForHarmonizationWithV26(int rep) throws HL7Exception { 
        return ((TBD)) super.removeRepetition(21, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public (TBD) removeObx21_ReservedForHarmonizationWithV26(int rep) throws HL7Exception { 
        return ((TBD)) super.removeRepetition(21, rep);
    }
    ...
    /**
     * Returns a count of the current number of repetitions of Reserved for harmonization with V2.6 (OBX-22).
     * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
     * it will return zero.
     */
    public int getReservedForHarmonizationWithV26Reps() {
    ...
    /**
     * Returns a specific repetition of
     * OBX-22: "Reserved for harmonization with V2.6" - creates it if necessary
     *
     * @param rep The repetition index (0-indexed)
     */
    public (TBD) getReservedForHarmonizationWithV26(int rep) { 
		(TBD) retVal = this.getTypedField(22, rep);
		return retVal;
    }
     ...
     * @param rep The repetition index (0-indexed)
     */
    public (TBD) getObx22_ReservedForHarmonizationWithV26(int rep) { 
		(TBD) retVal = this.getTypedField(22, rep);
		return retVal;
    }
     ...
     * it will return zero.
     */
    public int getObx22_ReservedForHarmonizationWithV26Reps() {
    	return this.getReps(22);
    }
    ...
    /**
     * Inserts a repetition of
     * OBX-22: "Reserved for harmonization with V2.6" at a specific index
     *
     * @param rep The repetition index (0-indexed)
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public (TBD) insertReservedForHarmonizationWithV26(int rep) throws HL7Exception { 
        return ((TBD)) super.insertRepetition(22, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public (TBD) insertObx22_ReservedForHarmonizationWithV26(int rep) throws HL7Exception { 
        return ((TBD)) super.insertRepetition(22, rep);
    }
     ...
     */
    public (TBD) removeReservedForHarmonizationWithV26(int rep) throws HL7Exception { 
        return ((TBD)) super.removeRepetition(22, rep);
    }
     ...
     * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
     */
    public (TBD) removeObx22_ReservedForHarmonizationWithV26(int rep) throws HL7Exception { 
        return ((TBD)) super.removeRepetition(22, rep);
    }
    ...
    protected Type createNewTypeWithoutReflection(int field) {
       switch (field) {
          ...
          case 5: return new CWE_ELR(getMessage());
          ...
          case 19: return new (TBD)(getMessage());
          case 20: return new (TBD)(getMessage());
          case 21: return new (TBD)(getMessage());

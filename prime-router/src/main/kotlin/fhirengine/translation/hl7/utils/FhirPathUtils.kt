...
object FhirPathUtils : Logging {
    ...
    // IMPORTANT NOTE: When Zip doesn't exist it appears to populate an empty "xad-address" extension,
    //      might be worth following up on
    //   Also when Zip doesn't exist, retVal is size 1 but everything is "0" "[]" "false" "null" or "true"

...
import gov.cdc.prime.router.settings.Sender.PrimarySubmissionMethod.automated
import gov.cdc.prime.router.settings.Sender.PrimarySubmissionMethod.manual
import gov.cdc.prime.router.settings.Sender.ProcessingType.async
import gov.cdc.prime.router.settings.Sender.ProcessingType.sync
import gov.cdc.prime.router.settings.Sender.SenderType.dataAggregator
import gov.cdc.prime.router.settings.Sender.SenderType.facility
import gov.cdc.prime.router.settings.Sender.SenderType.hospitalSystem
import gov.cdc.prime.router.settings.Sender.SenderType.testManufacturer
...
@JsonSubTypes(
    ...
    JsonSubTypes.Type(value = UniversalPipelineSender::class, name = "mars-otc-elr"),

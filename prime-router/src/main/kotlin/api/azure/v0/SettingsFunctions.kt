...
import gov.cdc.prime.router.api.azure.PRIME_ADMIN_PATTERN
...
import gov.cdc.prime.router.settings.SettingAPI
...
@Path("/v1/settings/organizations")
class SettingsFunctionV1(
            ...
            ApiResponse(
                ...
                content = [
                    Content(
                        ...
                        schema = Schema(implementation = ApiKeysFunctionsBase.ApiKeysResponse::class),
                        examples = [
                            ExampleObject(
    ...
    @GET
    @Path("/{organizationName}/public-keys")
...
class SettingsFunction(
    ...
    @Path("/{organizationName}/senders/{senderName}")
    @GET
    fun getOneSender(
        @HttpTrigger(
            name = "getOneSender",
    ...
    @Path("/{organizationName}/receivers")
    @GET
    ...
    @Path("/{organizationName}/receivers/{receiverName}")
    @GET
    fun getOneReceiver(
        @HttpTrigger(
            name = "getOneReceiver",
...
@Path("/waters/org/{organizationName}/")
class WatersOrganizationSettingsFunction(
    settingsFacade: SettingsFacade = SettingsFacade.common,
) : BaseFunction(settingsFacade) {
    /**
     ...
     */
    @Operation(
        operationId = "getSettingRevisionHistory"
    )
    @Path("/settings/revs/{settingSelector}")
    @GET

...
import gov.cdc.prime.router.report.db.ReportFileDatabaseAccess
...
@Path("/v1/reports")
class ReportsV1 : BaseHistoryFunction() {
    /**
...
class HistoryReports :
    ...
    @StorageAccount("AzureWebJobsStorage")
    @Operation(
        operationId = "getReportFacilities"
    )
    @Path("/{reportId}/facilities")
    @GET
    fun getReportFacilities(
        @HttpTrigger(

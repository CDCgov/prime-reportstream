...
class LookupTableFunctions(
    ...
    @Path("/{tableName}/{tableVersion}/content")
    @GET
    ...
    @Operation(
        operationId = "getActiveLookupTableContent"
    )
    ...
    @Operation(
        operationId = "getLookupTableInfo"
    )
    @Path("/{tableName}/{tableVersion}/info")
    @GET
    ...
    @Operation(
        operationId = "activateLookupTable"
    )
    @Path("/{tableName}/{tableVersion}/activate")
    @PUT

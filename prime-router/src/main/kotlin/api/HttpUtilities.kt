package gov.cdc.prime.router.api
...
import gov.cdc.prime.router.report.PAYLOAD_MAX_BYTES
...
class HttpUtilities {
    ...
    companion object : Logging {
        ...
        @OpenApiResponse(
            responseCode = "200",
            description = "OK",
            headers = [Header(name = "Last-Modified", schema = Schema(implementation = String::class))],
            content = [Content(schema = Schema(implementation = String::class))]
        )
        fun okResponse(
            request: HttpRequestMessage<String?>,

...
import gov.cdc.prime.router.transport.AS2TransportType
import gov.cdc.prime.router.transport.BlobStoreTransportType
import gov.cdc.prime.router.transport.GAENTransportType
import gov.cdc.prime.router.transport.ITransport
import gov.cdc.prime.router.transport.NullTransport
import gov.cdc.prime.router.transport.NullTransportType
...
import gov.cdc.prime.router.transport.TransportType

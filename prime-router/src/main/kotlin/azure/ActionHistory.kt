...
class ActionHistory : Logging {
    ...
    private val elrMetaDataRecords = mutableListOf<ElrResultMetadata>()
    private val covidResultMetadataRecords = mutableListOf<CovidResultMetadata>()
    ...
    internal fun insertAll(txn: Configuration) {
        ...
        DatabaseAccess.saveTestData(elrMetaDataRecords, txn)
        DatabaseAccess.saveCovidTestData(covidResultMetadataRecords, txn)

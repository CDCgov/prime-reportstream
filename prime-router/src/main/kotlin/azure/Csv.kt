...
class Csv {
    ...
    @get:JsonIgnore var csvContent: String // The actual content of the csv file.  @todo SHOULD NOT BE STRING.
    ...
    fun queueForProcessing(queue: QueueClient, blobContainerClient: BlobContainerClient, context: ExecutionContext) {
        ...
        val bytes = csvContent!!.toByteArray(Charset.forName("UTF-8"))

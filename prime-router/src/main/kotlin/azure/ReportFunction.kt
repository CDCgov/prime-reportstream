...
class ReportFunction(
    ...
    internal fun doDuplicateDetection(
        ...
        // NOTE: We also can use WorkflowEngine.isDuplicateFile here if needed; as of 4/11/2021 we are not using it
        //  due to potential for false postives since report_file digests are saved on failed submissions as well

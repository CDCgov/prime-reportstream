...
public class CWE_ELR extends AbstractComposite {

  private Type[] data;
  private boolean OBX5;

  /**
   * Creates a new CWE type
   */
  public CWE_ELR(Message message) {
    super(message);
    OBX5 = false;
    init();
  }
   ...
   * Creates a new CWE type
   */
  public CWE_ELR(Message message, boolean isOBX5) {
    super(message);
    OBX5 = isOBX5;
    init();
  }
  ...
  private void init() {
    ...
    data[14] = new NULLDT(getMessage());
    data[15] = new NULLDT(getMessage());
    data[16] = new NULLDT(getMessage());
    data[17] = new NULLDT(getMessage());
    data[18] = new NULLDT(getMessage());
    data[19] = new NULLDT(getMessage());
    data[20] = new NULLDT(getMessage());
    data[21] = new NULLDT(getMessage());
  }
   ...
   * casting and handling an exception.
   */
  public NULLDT getCwe16_ValueSetVersionID() {
    return getTyped(15, NULLDT.class);
  }
   ...
   * casting and handling an exception.
   */
  public NULLDT getAlternateCodingSystemOID() {
    return getTyped(16, NULLDT.class);
  }
   ...
   * casting and handling an exception.
   */
  public NULLDT getCwe17_AlternateCodingSystemOID() {
    return getTyped(16, NULLDT.class);
  }
   ...
   * casting and handling an exception.
   */
  public NULLDT getAlternateValueSetOID() {
    return getTyped(17, NULLDT.class);
  }
   ...
   * casting and handling an exception.
   */
  public NULLDT getCwe18_AlternateValueSetOID() {
    return getTyped(17, NULLDT.class);
  }
   ...
   * casting and handling an exception.
   */
  public NULLDT getAlternateValueSetVersionID() {
    return getTyped(18, NULLDT.class);
  }
   ...
   * casting and handling an exception.
   */
  public NULLDT getCwe19_AlternateValueSetVersionID() {
    return getTyped(18, NULLDT.class);
  }
   ...
   * casting and handling an exception.
   */
  public NULLDT getSecondAlternateCodingSystemOID() {
    return getTyped(19, NULLDT.class);
  }
   ...
   * casting and handling an exception.
   */
  public NULLDT getCwe20_SecondAlternateCodingSystemOID() {
    return getTyped(19, NULLDT.class);
  }
   ...
   * casting and handling an exception.
   */
  public NULLDT getSecondAlternateValueSetOID() {
    return getTyped(20, NULLDT.class);
  }
   ...
   * casting and handling an exception.
   */
  public NULLDT getCwe21_SecondAlternateValueSetOID() {
    return getTyped(20, NULLDT.class);
  }
   ...
   * casting and handling an exception.
   */
  public NULLDT getSecondAlternateValueSetVersionID() {
    return getTyped(21, NULLDT.class);
  }
   ...
   * casting and handling an exception.
   */
  public NULLDT getCwe22_SecondAlternateValueSetVersionID() {
    return getTyped(21, NULLDT.class);
  }

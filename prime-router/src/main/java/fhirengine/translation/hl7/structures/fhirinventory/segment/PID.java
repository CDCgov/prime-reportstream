 ...
 * <li>PID-35: Species Code (CWE) <b>optional </b>
...
public class PID extends AbstractSegment {
  ...
  private void init(ModelClassFactory factory) {
    try {
      ...
      this.add(CX.class, false, 1, 0, new Object[]{getMessage()}, "Patient ID");
      this.add(CX.class, true, 0, 0, new Object[]{getMessage()}, "Patient Identifier List");
      this.add(CX.class, false, 1, 0, new Object[]{getMessage()}, "Alternate Patient ID - PID");
      ...
      this.add(IS.class, false, 1, 0, new Object[]{getMessage()}, "County Code");
      ...
      this.add(ST.class, false, 1, 0, new Object[]{getMessage()}, "SSN Number - Patient");
      this.add(DLN.class, false, 1, 0, new Object[]{getMessage()}, "Driver's License Number - Patient");
      ...
      this.add(ID.class, false, 1, 1, new Object[]{getMessage(), Integer.valueOf(136)}, "Multiple Birth Indicator");
      ...
      this.add(ID.class, false, 1, 1, new Object[]{getMessage(), Integer.valueOf(136)}, "Patient Death Indicator");
      this.add(ID.class, false, 1, 1, new Object[]{getMessage(), Integer.valueOf(136)}, "Identity Unknown Indicator");
      ...
      this.add(CWE.class, false, 1, 0, new Object[]{getMessage()}, "Species Code");

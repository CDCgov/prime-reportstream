 ...
 * <li>SFT-6: Software Install Date (TS) <b> </b>
 * </ul>
 */
...
public class SFT extends AbstractSegment {
  ...
  private void init(ModelClassFactory factory) {
    try {
      this.add(XON_SFT.class, false, 1, 0, new Object[]{getMessage()}, "Software Vendor Organization");
      this.add(ST.class, false, 1, 0, new Object[]{getMessage()}, "Software Certified Version or Release Number");
      this.add(ST.class, false, 1, 0, new Object[]{getMessage()}, "Software Product Name");
      this.add(ST.class, false, 1, 0, new Object[]{getMessage()}, "Software Binary ID");
      this.add(TX.class, false, 1, 0, new Object[]{getMessage()}, "Software Product Information");
      this.add(TS_NIH.class, false, 1, 0, new Object[]{getMessage()}, "Software Install Date");
   ...
   */
  public XON_SFT getSoftwareVendorOrganization() {
    XON_SFT retVal = this.getTypedField(1, 0);
    return retVal;
  }
   ...
   * SFT-1: "Software Vendor Organization" - creates it if necessary
   */
  public XON_SFT getSft1_SoftwareVendorOrganization() {
    XON_SFT retVal = this.getTypedField(1, 0);
    return retVal;
  }
   ...
   */
  public TS_NIH getSoftwareInstallDate() {
    TS_NIH retVal = this.getTypedField(6, 0);
    return retVal;
  }
   ...
   * SFT-6: "Software Install Date" - creates it if necessary
   */
  public TS_NIH getSft6_SoftwareInstallDate() {
    TS_NIH retVal = this.getTypedField(6, 0);
    return retVal;
  }

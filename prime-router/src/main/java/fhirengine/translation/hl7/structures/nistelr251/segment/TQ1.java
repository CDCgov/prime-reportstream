...
public class TQ1 extends AbstractSegment {
  ...
  private void init(ModelClassFactory factory) {
    try {
      this.add(SI.class, false, 1, 0, new Object[]{getMessage()}, "Set ID - TQ1");
      this.add(CQ.class, false, 1, 0, new Object[]{getMessage()}, "Quantity");
      this.add(RPT.class, false, -1, 0, new Object[]{getMessage()}, "Repeat Pattern");
      this.add(TM.class, false, -1, 0, new Object[]{getMessage()}, "Explicit Time");
      this.add(CQ.class, false, -1, 0, new Object[]{getMessage()}, "Relative Time and Units");
      this.add(CQ.class, false, 1, 0, new Object[]{getMessage()}, "Service Duration");
      this.add(TS.class, false, 1, 0, new Object[]{getMessage()}, "Start date/time");
      this.add(TS.class, false, 1, 0, new Object[]{getMessage()}, "End date/time");

 ...
 * <li>NTE-9: Coded Comment (CWE) <b>optional repeating</b>
 * </ul>
 */
...
public class NTE extends AbstractSegment {
  ...
  private void init(ModelClassFactory factory) {
    try {
      ...
      this.add(CWE.class, false, 0, 0, new Object[]{getMessage()}, "Coded Comment");
  ...
  /**
   * Returns all repetitions of Coded Comment (NTE-9).
   */
  public CWE[] getCodedComment() {
   ...
   * Returns all repetitions of Coded Comment (NTE-9).
   */
  public CWE[] getNte9_CodedComment() {
    CWE[] retVal = this.getTypedField(9, new CWE[0]);
    return retVal;
  }
  ...
  /**
   * Returns a count of the current number of repetitions of Coded Comment (NTE-9).
   * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
   * it will return zero.
   */
  public int getCodedCommentReps() {
  ...
  /**
   * Returns a specific repetition of
   * NTE-9: "Coded Comment" - creates it if necessary
   *
   * @param rep The repetition index (0-indexed)
   */
  public CWE getCodedComment(int rep) {
   ...
   * @param rep The repetition index (0-indexed)
   */
  public CWE getNte9_CodedComment(int rep) {
    CWE retVal = this.getTypedField(9, rep);
    return retVal;
  }
   ...
   * it will return zero.
   */
  public int getNte9_CodedCommentReps() {
    return this.getReps(9);
  }
  ...
  /**
   * Inserts a repetition of
   * NTE-9: "Coded Comment" at a specific index
   *
   * @param rep The repetition index (0-indexed)
   * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
   */
  public CWE insertCodedComment(int rep) throws HL7Exception {
   ...
   * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
   */
  public CWE insertNte9_CodedComment(int rep) throws HL7Exception {
    return (CWE) super.insertRepetition(9, rep);
  }
   ...
   * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
   */
  public CWE removeCodedComment(int rep) throws HL7Exception {
   ...
   * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
   */
  public CWE removeNte9_CodedComment(int rep) throws HL7Exception {
    return (CWE) super.removeRepetition(9, rep);
  }

 ...
 * <ul>
 * <li>NTE-1: Set ID - NTE (SI) <b> </b>
 * <li>NTE-2: Source of Comment (ID) <b>optional </b>
 * <li>NTE-3: Comment (FT) <b> repeating</b>
 * <li>NTE-4: Comment Type (CWE_NIH) <b>optional </b>
 * </ul>
 */
...
public class NTE extends AbstractSegment {
  ...
  private void init(ModelClassFactory factory) {
    try {
      this.add(SI.class, true, 1, 4, new Object[]{getMessage()}, "Set ID - NTE");
      this.add(ID.class, false, 1, 8, new Object[]{getMessage(), Integer.valueOf(105)}, "Source of Comment");
      this.add(FT.class, true, 0, 65536, new Object[]{getMessage()}, "Comment");
      this.add(CWE_NIH.class, false, 1, 0, new Object[]{getMessage()}, "Comment Type");
   ...
   */
  public CWE_NIH getCommentType() {
    CWE_NIH retVal = this.getTypedField(4, 0);
    return retVal;
  }
   ...
   * NTE-4: "Comment Type" - creates it if necessary
   */
  public CWE_NIH getNte4_CommentType() {
    CWE_NIH retVal = this.getTypedField(4, 0);
    return retVal;
  }

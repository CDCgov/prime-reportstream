...
public class RP_ELR extends AbstractComposite {
  ...
  private void init() {
    ...
    data[1] = new HD_ELR(getMessage(), true);
    data[2] = new ID(getMessage(), 834);
   ...
   * casting and handling an exception.
   */
  public HD_ELR getApplicationID() {
    return getTyped(1, HD_ELR.class);
  }
   ...
   * casting and handling an exception.
   */
  public HD_ELR getRp2_ApplicationID() {
    return getTyped(1, HD_ELR.class);
  }

...
public class XCN_ELR extends AbstractComposite {
   ...
   */
  public XCN_ELR(Message message) {
    super(message);
    init();
  }
  ...
  public HD_ELR getAssigningAuthority() {
    return getTyped(8, HD_ELR.class);
  }
   ...
   * casting and handling an exception.
   */
  public HD_ELR getXcn9_AssigningAuthority() {
    return getTyped(8, HD_ELR.class);
  }
  ...
  public HD_ELR getAssigningFacility() {
    return getTyped(13, HD_ELR.class);
  }
   ...
   * casting and handling an exception.
   */
  public HD_ELR getXcn14_AssigningFacility() {
    return getTyped(13, HD_ELR.class);
  }

...
public class ORC extends AbstractSegment {
  ...
  private void init(ModelClassFactory factory) {
    try {
      this.add(ID.class, true, 1, 2, new Object[]{getMessage(), Integer.valueOf(119)}, "Order Control");
  ...
  protected Type createNewTypeWithoutReflection(int field) {
    switch (field) {
      case 0:
        return new ID(getMessage(), Integer.valueOf(119));
      case 1:
      ...
      case 3:
        return new EI(getMessage());
      case 4:
        return new ID(getMessage(), Integer.valueOf(38));
      case 5:

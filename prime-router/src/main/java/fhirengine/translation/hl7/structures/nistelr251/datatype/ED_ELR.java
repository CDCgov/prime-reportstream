...
public class ED_ELR extends AbstractComposite {
  ...
  private void init() {
    data = new Type[5];
    data[0] = new HD_ELR(getMessage());
    data[1] = new ID(getMessage(), 834);
   ...
   */
  public HD_ELR getSourceApplication() {
    return getTyped(0, HD_ELR.class);
  }
   ...
   * casting and handling an exception.
   */
  public HD_ELR getEd1_SourceApplication() {
    return getTyped(0, HD_ELR.class);
  }

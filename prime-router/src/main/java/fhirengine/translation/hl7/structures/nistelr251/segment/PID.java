...
public class PID extends AbstractSegment {
  ...
  private void init(ModelClassFactory factory) {
    try {
      ...
      this.add(CX.class, false, 0, 0, new Object[]{getMessage()}, "Alternate Patient ID - PID");
      ...
      this.add(ST.class, false, 0, 0, new Object[]{getMessage()}, "SSN Number - Patient");
      this.add(DLN.class, false, 0, 0, new Object[]{getMessage()}, "Driver's License Number - Patient");

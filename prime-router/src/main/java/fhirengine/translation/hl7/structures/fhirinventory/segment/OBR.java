...
public class OBR extends AbstractSegment {
  ...
  private void init(ModelClassFactory factory) {
    try {
      ...
      this.add(ID.class, false, 1, 1, new Object[]{getMessage(), Integer.valueOf(224)}, "Transport Arranged");
      this.add(ID.class, false, 1, 1, new Object[]{getMessage(), Integer.valueOf(225)}, "Escort Required");
  ...
  protected Type createNewTypeWithoutReflection(int field) {
    switch (field) {
      ...
      case 29:
        return new ID(getMessage(), Integer.valueOf(124));
      case 30:
        return new CWE(getMessage());
      case 31:
      ...
      case 39:
        return new CWE(getMessage());
      case 40:
        return new ID(getMessage(), Integer.valueOf(224));
      case 41:
        return new ID(getMessage(), Integer.valueOf(225));
      case 42:
        return new CWE(getMessage());
      case 43:

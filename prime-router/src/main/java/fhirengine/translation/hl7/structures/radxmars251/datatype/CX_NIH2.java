...
public class CX_NIH2 extends AbstractComposite {
   ...
   */
  public CX_NIH2(Message message) {
    super(message);
    init();
  }
  ...
  private void init() {
    ...
    data[3] = new HD_NIH2(getMessage());
    data[4] = new ID(getMessage(), 203);
    data[5] = new HD_NIH(getMessage());
    data[6] = new DT(getMessage());
    data[7] = new DT(getMessage());
    data[8] = new CWE_NIH(getMessage());
    data[9] = new CWE_NIH(getMessage());
  }
  ...
  public HD_NIH2 getAssigningAuthority() {
    return getTyped(3, HD_NIH2.class);
  }
   ...
   * casting and handling an exception.
   */
  public HD_NIH2 getCx4_AssigningAuthority() {
    return getTyped(3, HD_NIH2.class);
  }
  ...
  public HD_NIH getAssigningFacility() {
    return getTyped(5, HD_NIH.class);
  }
   ...
   * casting and handling an exception.
   */
  public HD_NIH getCx6_AssigningFacility() {
    return getTyped(5, HD_NIH.class);
  }
  ...
  public CWE_NIH getAssigningJurisdiction() {
    return getTyped(8, CWE_NIH.class);
  }
   ...
   * casting and handling an exception.
   */
  public CWE_NIH getCx9_AssigningJurisdiction() {
    return getTyped(8, CWE_NIH.class);
  }
  ...
  public CWE_NIH getAssigningAgencyOrDepartment() {
    return getTyped(9, CWE_NIH.class);
  }
   ...
   * casting and handling an exception.
   */
  public CWE_NIH getCx10_AssigningAgencyOrDepartment() {
    return getTyped(9, CWE_NIH.class);
  }

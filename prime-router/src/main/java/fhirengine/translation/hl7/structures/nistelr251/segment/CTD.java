...
public class CTD extends AbstractSegment {
  ...
  private void init(ModelClassFactory factory) {
    try {
      this.add(CE.class, true, -1, 0, new Object[]{getMessage()}, "Contact Role");
      this.add(XPN.class, false, -1, 0, new Object[]{getMessage()}, "Contact Name");
      this.add(XAD.class, false, -1, 0, new Object[]{getMessage()}, "Contact Address");
      this.add(PL.class, false, 1, 0, new Object[]{getMessage()}, "Contact Location");
      this.add(XTN.class, false, -1, 0, new Object[]{getMessage()}, "Contact Communication Information");
      this.add(CE.class, false, 1, 0, new Object[]{getMessage()}, "Preferred Method of Contact");
      this.add(PLN.class, false, -1, 0, new Object[]{getMessage()}, "Contact Identifiers");

...
public class XON_OBX_23 extends AbstractComposite {
   ...
   */
  public XON_OBX_23(Message message) {
    super(message);
    init();
  }
   ...
   * casting and handling an exception.
   */
  public NULLDT getXon3_IDNumber() {
    return getTyped(2, NULLDT.class);
  }
  ...
  public HD_NIH2 getAssigningAuthority() {
    return getTyped(5, HD_NIH2.class);
  }
   ...
   * casting and handling an exception.
   */
  public HD_NIH2 getXon6_AssigningAuthority() {
    return getTyped(5, HD_NIH2.class);
  }

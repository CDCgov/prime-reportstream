...
public class PV1 extends AbstractSegment {
  ...
  private void init(ModelClassFactory factory) {
    try {
      ...
      this.add(IS.class, true, 1, 0, new Object[]{getMessage(), 4}, "Patient Class");
      this.add(PL.class, false, 1, 0, new Object[]{getMessage()}, "Assigned Patient Location");
      this.add(IS.class, false, 1, 0, new Object[]{getMessage(), 0}, "Admission Type");
      ...
      this.add(IS.class, false, 1, 0, new Object[]{getMessage(), 0}, "Hospital Service");
      this.add(PL.class, false, 1, 0, new Object[]{getMessage()}, "Temporary Location");
      this.add(IS.class, false, 1, 0, new Object[]{getMessage(), 87}, "Preadmit Test Indicator");
      this.add(IS.class, false, 0, 0, new Object[]{getMessage(), 0}, "Re-admission Indicator");
      this.add(IS.class, false, 1, 0, new Object[]{getMessage(), 23}, "Admit Source");
      this.add(IS.class, false, 0, 0, new Object[]{getMessage(), 0}, "Ambulatory Status");
      this.add(IS.class, false, 0, 0, new Object[]{getMessage(), 0}, "VIP Indicator");
      ...
      this.add(NULLDT.class, false, 0, 0, new Object[]{getMessage(), 0}, "Charge Price Indicator");
      this.add(NULLDT.class, false, 0, 0, new Object[]{getMessage(), 0}, "Courtesy Code");
      this.add(NULLDT.class, false, 0, 0, new Object[]{getMessage(), 0}, "Credit Rating");
      this.add(NULLDT.class, false, 0, 0, new Object[]{getMessage(), 0}, "Contract Code");
      this.add(NULLDT.class, false, 0, 0, new Object[]{getMessage()}, "Contract Effective Date");
      this.add(NULLDT.class, false, 0, 0, new Object[]{getMessage()}, "Contract Amount");
      this.add(NULLDT.class, false, 0, 0, new Object[]{getMessage()}, "Contract Period");
      this.add(NULLDT.class, false, 0, 0, new Object[]{getMessage(), 0}, "Interest Code");
      this.add(IS.class, false, 0, 0, new Object[]{getMessage(), 0}, "Transfer to Bad Debt Code");
      this.add(DT.class, false, 1, 0, new Object[]{getMessage()}, "Transfer to Bad Debt Date");
      this.add(IS.class, false, 1, 0, new Object[]{getMessage(), 21}, "Bad Debt Agency Code");
      ...
      this.add(IS.class, false, 1, 0, new Object[]{getMessage(), 111}, "Delete Account Indicator");
      this.add(DT.class, false, 1, 0, new Object[]{getMessage()}, "Delete Account Date");
      this.add(IS.class, false, 1, 0, new Object[]{getMessage(), 112}, "Discharge Disposition");
      ...
      this.add(IS.class, false, 1, 0, new Object[]{getMessage(), 115}, "Servicing Facility");
      this.add(NULLDT.class, false, 0, 0, new Object[]{getMessage(), 0}, "Bed Status");
      ...
      this.add(IS.class, false, 1, 0, new Object[]{getMessage(), 326}, "Visit Indicator");

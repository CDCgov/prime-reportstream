...
public class XCN_NIH2 extends AbstractComposite {
   ...
   */
  public XCN_NIH2(Message message) {
    super(message);
    init();
  }
  ...
  private void init() {
    ...
    data[21] = new CWE_NIH(getMessage());
    data[22] = new CWE_NIH(getMessage());
  }
   ...
   * casting and handling an exception.
   */
  public HD_NIH2 getAssigningAuthority() {
    return getTyped(8, HD_NIH2.class);
  }
   ...
   * casting and handling an exception.
   */
  public HD_NIH2 getXcn9_AssigningAuthority() {
    return getTyped(8, HD_NIH2.class);
  }
   ...
   * casting and handling an exception.
   */
  public HD_NIH getAssigningFacility() {
    return getTyped(13, HD_NIH.class);
  }
   ...
   * casting and handling an exception.
   */
  public HD_NIH getXcn14_AssigningFacility() {
    return getTyped(13, HD_NIH.class);
  }
   ...
   * casting and handling an exception.
   */
  public NULLDT getNameValidityRange() {
   ...
   * casting and handling an exception.
   */
  public NULLDT getXcn17_NameValidityRange() {
    return getTyped(16, NULLDT.class);
  }
   ...
   * casting and handling an exception.
   */
  public CWE_NIH getAssigningJurisdiction() {
    return getTyped(21, CWE_NIH.class);
  }
   ...
   * casting and handling an exception.
   */
  public CWE_NIH getXcn22_AssigningJurisdiction() {
    return getTyped(21, CWE_NIH.class);
  }
   ...
   * casting and handling an exception.
   */
  public CWE_NIH getAssigningAgencyOrDepartment() {
    return getTyped(22, CWE_NIH.class);
  }
   ...
   * casting and handling an exception.
   */
  public CWE_NIH getXcn23_AssigningAgencyOrDepartment() {
    return getTyped(22, CWE_NIH.class);
  }

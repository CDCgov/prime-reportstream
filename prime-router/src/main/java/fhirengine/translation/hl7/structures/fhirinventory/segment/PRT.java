 ...
 * <li>PRT-16: UDI Device Identifier (EI) <b>optional </b>
 * <li>PRT-17: Device Manufacture Date (DTM) <b>optional </b>
 * <li>PRT-18: Device Expiry Date (DTM) <b>optional </b>
...
public class PRT extends AbstractSegment {
  ...
  private void init(ModelClassFactory factory) {
    try {
      ...
      this.add(ID.class, true, 1, 2, new Object[]{getMessage(), Integer.valueOf(287)}, "Action Code");
      ...
      this.add(EI.class, false, 1, 0, new Object[]{getMessage()}, "UDI Device Identifier");
      this.add(DTM.class, false, 1, 0, new Object[]{getMessage()}, "Device Manufacture Date");
      this.add(DTM.class, false, 1, 0, new Object[]{getMessage()}, "Device Expiry Date");
  ...
  /**
   * Returns
   * PRT-16: "UDI Device Identifier" - creates it if necessary
   */
  public EI getUDIDeviceIdentifier() {
    EI retVal = this.getTypedField(16, 0);
    return retVal;
  }
   ...
   * PRT-16: "UDI Device Identifier" - creates it if necessary
   */
  public EI getPrt16_UDIDeviceIdentifier() {
    EI retVal = this.getTypedField(16, 0);
    return retVal;
  }
  ...
  /**
   * Returns
   * PRT-17: "Device Manufacture Date" - creates it if necessary
   */
  public DTM getDeviceManufactureDate() {
   ...
   * PRT-17: "Device Manufacture Date" - creates it if necessary
   */
  public DTM getPrt17_DeviceManufactureDate() {
    DTM retVal = this.getTypedField(17, 0);
    return retVal;
  }
  ...
  /**
   * Returns
   * PRT-18: "Device Expiry Date" - creates it if necessary
   */
  public DTM getDeviceExpiryDate() {
   ...
   * PRT-18: "Device Expiry Date" - creates it if necessary
   */
  public DTM getPrt18_DeviceExpiryDate() {
    DTM retVal = this.getTypedField(18, 0);
    return retVal;
  }
  ...
  /**
   * Returns
   * PRT-19: "Device Lot Number" - creates it if necessary
   */
  public ST getDeviceLotNumber() {
   ...
   * PRT-19: "Device Lot Number" - creates it if necessary
   */
  public ST getPrt19_DeviceLotNumber() {
    ST retVal = this.getTypedField(19, 0);
    return retVal;
  }
  ...
  /**
   * Returns
   * PRT-20: "Device Serial Number" - creates it if necessary
   */
   ...
   * PRT-20: "Device Serial Number" - creates it if necessary
   */
  public ST getPrt20_DeviceSerialNumber() {
    ST retVal = this.getTypedField(20, 0);
    return retVal;
  }
  ...
  /**
   * Returns
   * PRT-21: "Device Donation Identification" - creates it if necessary
   */
  public EI getDeviceDonationIdentification() {
   ...
   * PRT-21: "Device Donation Identification" - creates it if necessary
   */
  public EI getPrt21_DeviceDonationIdentification() {
    EI retVal = this.getTypedField(21, 0);
    return retVal;
  }
  ...
  /**
   * Returns
   * PRT-23: "Preferred Method of Contact" - creates it if necessary
   */
   ...
   * PRT-23: "Preferred Method of Contact" - creates it if necessary
   */
  public CWE getPrt23_PreferredMethodOfContact() {
    CWE retVal = this.getTypedField(23, 0);
    return retVal;
  }
  ...
  /**
   * Returns all repetitions of Contact Identifiers (PRT-24).
   */
  public PLN[] getContactIdentifiers() {
    PLN[] retVal = this.getTypedField(24, new PLN[0]);
    return retVal;
  }
   ...
   * Returns all repetitions of Contact Identifiers (PRT-24).
   */
  public PLN[] getPrt24_ContactIdentifiers() {
    PLN[] retVal = this.getTypedField(24, new PLN[0]);
    return retVal;
  }
  ...
  /**
   * Returns a count of the current number of repetitions of Contact Identifiers (PRT-24).
   * This method does not create a repetition, so if no repetitions have currently been defined or accessed,
   * it will return zero.
   */
  ...
  /**
   * Returns a specific repetition of
   * PRT-24: "Contact Identifiers" - creates it if necessary
   *
   * @param rep The repetition index (0-indexed)
   */
  public PLN getContactIdentifiers(int rep) {
    PLN retVal = this.getTypedField(24, rep);
    return retVal;
  }
   ...
   * @param rep The repetition index (0-indexed)
   */
  public PLN getPrt24_ContactIdentifiers(int rep) {
    PLN retVal = this.getTypedField(24, rep);
    return retVal;
  }
   ...
   * it will return zero.
   */
  public int getPrt24_ContactIdentifiersReps() {
    return this.getReps(24);
  }
  ...
  /**
   * Inserts a repetition of
   * PRT-24: "Contact Identifiers" at a specific index
   *
   * @param rep The repetition index (0-indexed)
   * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
   */
  public PLN insertContactIdentifiers(int rep) throws HL7Exception {
    return (PLN) super.insertRepetition(24, rep);
  }
   ...
   * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
   */
  public PLN insertPrt24_ContactIdentifiers(int rep) throws HL7Exception {
    return (PLN) super.insertRepetition(24, rep);
  }
  ...
  public PLN removeContactIdentifiers(int rep) throws HL7Exception {
    return (PLN) super.removeRepetition(24, rep);
  }
   ...
   * @throws HL7Exception If the rep is invalid (below 0, or too high for the allowable repetitions)
   */
  public PLN removePrt24_ContactIdentifiers(int rep) throws HL7Exception {
    return (PLN) super.removeRepetition(24, rep);
  }
  ...
  protected Type createNewTypeWithoutReflection(int field) {
    switch (field) {
      ...
      case 1:
        return new ID(getMessage(), Integer.valueOf(287));
      case 2:

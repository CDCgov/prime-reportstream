...
/**
 * <p>Represents a ORU_R01_PATIENT_OBSERVATION group structure (a Group object).
...
public class ORU_R01_PATIENT_OBSERVATION extends AbstractGroup {

  /**
   * Creates a new ORU_R01_PATIENT_OBSERVATION group
   */
  public ORU_R01_PATIENT_OBSERVATION(Group parent, ModelClassFactory factory) {
  ...
  private void init(ModelClassFactory factory) {
    try {
      ...
      log.error("Unexpected error creating ORU_R01_PATIENT_OBSERVATION - this is probably a bug in the source code generator.", e);
    }
  }

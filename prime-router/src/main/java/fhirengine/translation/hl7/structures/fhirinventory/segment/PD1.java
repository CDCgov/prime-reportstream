...
public class PD1 extends AbstractSegment {
  ...
  private void init(ModelClassFactory factory) {
    try {
      ...
      this.add(XCN.class, false, 0, 0, new Object[]{getMessage()}, "Patient Primary Care Provider Name & ID No.");
      ...
      this.add(ID.class, false, 1, 1, new Object[]{getMessage(), Integer.valueOf(136)}, "Separate Bill");
      ...
      this.add(ID.class, false, 1, 1, new Object[]{getMessage(), Integer.valueOf(136)}, "Protection Indicator");

...
public class XON_ORC_21 extends AbstractComposite {
   ...
   */
  public XON_ORC_21(Message message) {
    super(message);
    init();
  }
   ...
   * casting and handling an exception.
   */
  public HD_NIH getAssigningAuthority() {
   ...
   * casting and handling an exception.
   */
  public HD_NIH getXon6_AssigningAuthority() {
    return getTyped(5, HD_NIH.class);
  }

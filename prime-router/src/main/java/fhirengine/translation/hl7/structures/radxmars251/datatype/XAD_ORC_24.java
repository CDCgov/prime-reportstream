...
public class XAD_ORC_24 extends AbstractComposite {
   ...
   */
  public XAD_ORC_24(Message message) {
    super(message);
    init();
  }
   ...
   */
  public SAD_NIH getStreetAddress() {
    return getTyped(0, SAD_NIH.class);
  }
   ...
   * casting and handling an exception.
   */
  public SAD_NIH getXad1_StreetAddress() {
    return getTyped(0, SAD_NIH.class);
  }

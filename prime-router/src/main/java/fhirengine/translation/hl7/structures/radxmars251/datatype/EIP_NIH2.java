...
public class EIP_NIH2 extends AbstractComposite {
   ...
   */
  public EIP_NIH2(Message message) {
    super(message);
    init();
  }
  ...
  private void init() {
    data = new Type[2];
    data[0] = new EI_NIH(getMessage());
    data[1] = new EI_NIH2(getMessage());
  }
   ...
   */
  public EI_NIH getPlacerAssignedIdentifier() {
    return getTyped(0, EI_NIH.class);
  }
   ...
   * casting and handling an exception.
   */
  public EI_NIH getEip1_PlacerAssignedIdentifier() {
    return getTyped(0, EI_NIH.class);
  }
   ...
   * casting and handling an exception.
   */
  public EI_NIH2 getFillerAssignedIdentifier() {
    return getTyped(1, EI_NIH2.class);
  }
   ...
   * casting and handling an exception.
   */
  public EI_NIH2 getEip2_FillerAssignedIdentifier() {
    return getTyped(1, EI_NIH2.class);
  }

...
* [UP SR FHIR bundle](../onboarding-users/sample-messages/senders/simple-report/SR_UP_02262024.fhir)
* [CP SR CSV message](../onboarding-users/sample-messages/senders/simple-report/SR_CP_02262024.csv)  
...
* The file [SR upload](../onboarding-users/sample-messages/senders/simple-report/SR-UPLOAD.csv) can be used test sending reports through SimpleReport's CSV upload.    
...
* Status returns anything related to credentials: This probably means the credentials were not created correctly or are not present.
    * Instructions on how to create credentials can be found here:
        * [REST](../onboarding-users/transport/rest/rest.md)
        * [SFTP](../onboarding-users/transport/sftp/sftp.md)

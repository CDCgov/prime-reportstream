...
* `conditionFilter` should be added though to limit the results according to the STLTs requirements. This is an example to only route Covid tests `# Accept COVID only 

...
```shell
docker compose --env-file .env -f docker-compose.build.yml stop postgresql
docker compose --env-file .env -f docker-compose.build.yml rm postgresql
docker compose --env-file .env -f docker-compose.build.yml up -d postgresql
```

...
$limit = [datetime]::Now.AddDays(7)

$markdownTable = @"
| Pull Request Number | Title | URL | User |
|---------------------|-------|-----|------|`n
"@
...
echo "STALE_PULL_REQUESTS_MARKDOWN=$encodedMarkdownTable" | Out-File -FilePath $Env:GITHUB_ENV -Encoding utf8 -Append

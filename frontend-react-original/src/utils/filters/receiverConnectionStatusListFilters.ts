 ...
 * @param search {string}
 */
export function filterOnName(
    obj: RSReceiverStatus,
    search: string | null,
): boolean {
    if (!search) {
    ...
    return `${obj.organizationName} ${obj.receiverName}`
        .toLowerCase()
        .includes(`${search.toLowerCase()}`);
}

export function filterOnCheckResultStr(
    obj: RSReceiverStatus,
    search: string | null,
): boolean {
    if (!search) {
    ...
    return `${obj.connectionCheckResult}`
        .toLowerCase()
        .includes(`${search.toLowerCase()}`);
}

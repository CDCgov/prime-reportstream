...
export interface AlertProps extends Omit<OrigAlertProps, "validation" | "type" | "headingLevel"> {
...
const Alert = ({
    ...
    const alertIcon = icon == null || typeof icon === "string" ? <Icon name={icon ?? getIconName(_type)} /> : icon;
 ...
 */
export const AlertSimple = (props: Omit<AlertProps, "icon"> & { icon?: IconName }) => <Alert {...props} />;

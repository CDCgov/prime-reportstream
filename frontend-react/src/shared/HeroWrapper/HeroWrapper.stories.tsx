    ...
    <HeroWrapper>
        <header>
            <h1 className="margin-y-2">
                Your single connection to simplify data transfer and improve
                public health
            </h1>
            <p className="font-sans-lg margin-top-4">
                ReportStream is CDC’s free, interoperable platform for
                streamlining public health reporting. We navigate unique,
                complex requirements and work to make sure your data gets where
                it needs to be.
            </p>

...
export type LiveMapProps = PropsWithChildren<HTMLAttributes<HTMLElement> & ContentItem>;

const LiveMap = ({ title, summary, subTitle, description, ...props }: LiveMapProps) => {
    return (
        <section {...props}>
            ...
            <div data-testid="map" className="desktop:grid-col-8 desktop:grid-offset-2 margin-y-8">

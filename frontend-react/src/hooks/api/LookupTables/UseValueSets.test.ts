...
import { lookupTableServer } from "../../../config/__mocks__/LookupTableMockServer";
import { QueryWrapper } from "../../../utils/CustomRenderUtils";
import { LookupTables, ValueSet } from "../../../config/api/lookupTables";
...
describe("useValueSetsTable", () => {
    ...
    test("returns expected data values when fetching table version", async () => {
        ...
        // TODO: Research how to get typescript inference from jest methods
        // as this wouldn't be undefined

            ...
            <div className="usa-alert usa-alert--emergency">
                <div className="usa-alert__body">
                    ...
                    <p className="usa-alert__text">
                        ...
                        platform. For organizations interested in also transitioning to AIMS, APHL will provide detailed
                        information and dedicated assistance to facilitate a smooth migration for your integration.
                        Please use the{" "}
                        <a
                            href="https://aphlinformatics.atlassian.net/servicedesk/customer/portal/23/"
                            className="usa-link"
                        >
                            AIMS Platform Customer Portal
                        </a>{" "}
                        and submit a ticket to arrange your organization&apos;s onboarding to the APHL AIMS platform. If
                        you have specific questions related to the ReportStream sunset, please contact{" "}

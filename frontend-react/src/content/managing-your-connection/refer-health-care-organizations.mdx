...
Let us know if we can provide any additional content, such as a logo or more copy.
...
SimpleReport can be used for manual reporting or CSV upload and does not require technical staff. 
...
Learn more about how organizations get started sending data with ReportStream.
---
metaData:
    metaTitle: Getting started with ReportStream's API
    metaDescription: Resources and support to set up your connection and format your data. Our onboarding guide will walk you through the steps needed to get started.
    openGraphImage:
...
### Set up authentication with a public/private key pair
    ...
    The examples below uses the fake `client-id healthy-labs` that you will change for your submissions.

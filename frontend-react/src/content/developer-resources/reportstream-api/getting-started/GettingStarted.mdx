...
<A href={site.external.nistValidationTool.url}>NIST Electronic Lab Reporting (ELR) Validation Suite</A>. 
(Note: If you’re testing OTC data, use the NIST HL7 General Validation Tool and select “RADx MARS HL7v2” from 
the tool scope dropdown. Navigate to the “Context-free” tab and select the “Onboarding” profile group.) Correct 

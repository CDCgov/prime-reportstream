...
export const handleClick = () => {
    trackAppInsightEvent("ReportStream API", {});
};
...
<LayoutMain>
    ...
    <p>Our API guide and documentation is also available as a <a href={DOMPurify.sanitize(site.assets.programmersGuidePdf.path)} target="_blank" rel="noopener noreferrer" download><Button type="button" unstyled onClick={handleClick}>downloadable PDF</Button></a>.</p>

    ***
    <br/>

    ## <a href="frontend-react/src/content/developer-resources/reportstream-api/ReportStreamApi.mdx#onboarding-overview" className="usa-link usa-link--unstyled">Onboarding overview</a>
    ...
    ***
    ...
    ## <a href="frontend-react/src/content/developer-resources/reportstream-api/ReportStreamApi.mdx#about-our-api" className="usa-link usa-link--unstyled">About our API</a>

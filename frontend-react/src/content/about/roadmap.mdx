...
<ReleaseNote
    ...
    sections={[
        ...
        },
        {
            ...
            tag: "working-on-now",
            body: (
                <p>Design and develop a tool for healthcare organizations to map their local codes to standard coding systems, streamlining a manual step of the onboarding process.</p>
            ),
        },
        {
            tag: "next",
            body: (
                <p>Update and publish documentation for ReportStream’s Submission History API that healthcare organizations to reference as they interpret the status of their messages.</p>
            ),
        },
        {

...
* 100% of the 64 <A href="https://www.cdc.gov/elc/elc-overview.html" target="_blank">ELC-funded</A> state, tribal, local, or territorial public health agencies (STLTs) are connected to ReportStream.
* At least 15 <A href="https://www.cdc.gov/elc/elc-overview.html" target="_blank">ELC-funded</A> STLTs receive live data for two or more reportable conditions from ReportStream via ELR.

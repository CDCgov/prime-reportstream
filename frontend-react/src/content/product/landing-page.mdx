...
<LayoutMain>
    ...
    - [How ReportStream works](#how-reportstream-works)
    - [Who ReportStream supports](#who-reportstream-supports)
    - [How ReportStream receives data](#how-reportstream-receives-data)
    ...
    ![Diagram showing simplified point-to-point ELR connections](/assets/report-stream-application.png)
    </div>
    <div className="tablet:grid-col-6 ">
    <h3 data-testid="heading" className="font-sans-sm margin-top-0 padding-top-0 margin-bottom-1 ">1. Data download</h3>
    ...
    <div className="grid-row grid-gap display-flex flex-row flex-align-top">
    <div className="tablet:grid-col-6">
    ![Example screenshot of the ReportStream web application](/assets/rs-diagram.svg)
    </div>
    <div className="tablet:grid-col-6 ">
    <h3 data-testid="heading" className="font-sans-sm margin-top-0 padding-top-0 margin-bottom-1 ">2. Electronic lab reporting</h3>
    ...
    ### How ReportStream receives data

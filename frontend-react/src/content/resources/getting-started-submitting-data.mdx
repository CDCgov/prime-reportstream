---
title: Guide to submitting data to ReportStream
subtitle: A step-by-step process for connecting your lab or facility to ReportStream
breadcrumbs:
  - label: Resources
    href: /resources
  - label: Guide to submitting data to ReportStream
---
## Overview
...
<ProcessList>
  <ProcessListItem>
    <ProcessListHeading type="h2">Schedule kick-off:</ProcessListHeading>
    <p>
        Let us know you're interested by filling out and
        submitting [this form](https://app.smartsheetgov.com/b/form/8c71931f25e64e42bf1fef32900bdecd). We'll be in touch within a week to schedule a kick-off
  ...
  <ProcessListItem>
    <ProcessListHeading type="h2">Connect and test:</ProcessListHeading>
    <p>
  ...
  <ProcessListItem>
    <ProcessListHeading type="h2">Launch and roll out:</ProcessListHeading>
    <p>

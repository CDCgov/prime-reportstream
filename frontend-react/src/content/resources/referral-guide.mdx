---
title: How to refer users to ReportStream
subtitle: This guide provides instructions and communications for referring disease reporting entities to use ReportStream.
lastUpdated: 05/19/22
breadcrumbs:
  - label: Resources
    href: /resources
  - label: ReportStream referral guide
---

import { Button, Icon, Alert, Table } from "@trussworks/react-uswds";
...
<a href="" className="usa-button">Download Excel file (.xlsx) <Icon.FileDownload /></a> Last updated: 1/6/23
...
[This is the most updated LIVD mapping]() from the CDC. Specifics about each field are detailed in the tables below.
...
<Alert type="info">
    ...
    <ul>
        ...
        <li>For HL7 implementations, do not use this table. Refer to the RADx MARS Getting started guide.</li>
    </ul>
</Alert>
}

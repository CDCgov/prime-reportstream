...
2. Send the public key to the ReportStream team using [our public key tool](/file-handler/validate).
Note: you’ll need to login to use that feature. ReportStream will associate the key with your configuration within ReportStream.

...
<CardGroup>
    <Card>
        <CardHeader>[Data model]()</CardHeader>
        <CardBody>
...
<Alert type="info" headingLevel="div" heading="Note for HL7 OTC tests:" slim={true} className="border-0 font-sans-xs">
    For this step, refer to the RADx MARS Getting started guide.
    ...
    To configure the validator, refer to NIST HL7v2 validator instructions at the bottom of the RADx MARS Getting started guide.
</Alert>
...
<CardGroup>
    <Card>
        <CardHeader typeOf="div">[ReportStream File Validator]()</CardHeader>
        <CardBody>

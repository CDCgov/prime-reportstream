import { CardGroup, Card, CardBody, CardHeader, Accordion } from "@trussworks/react-uswds";
...
<Alert type="info" tip>For this step, refer to the [RADx MARS Getting started guide](https://www.nibib.nih.gov/covid-19/radx-tech-program/mars/hl7v2-getting-started).
...
<Alert type="info" tip icon={"Alarm"}>**Note:** Do not send any PII or PHI to the staging system — only fake (dummy, example, synthetic) data is acceptable.</Alert>

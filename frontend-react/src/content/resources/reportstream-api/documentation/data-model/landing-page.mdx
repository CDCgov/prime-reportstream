...
sidenav: content/resources/reportstream-api/sidenav
---
...
<p className="usa-intro text-base">{frontmatter.subtitle}</p>

<A href="/assets/xlsx/ReportStream CSV and HL7 Field Requirements (version 3.0).xlsx" className="usa-button">Download Excel file (.xlsx) <Icon name="FileDownload" className="usa-icon--auto" /></A> Last updated: 1/6/23

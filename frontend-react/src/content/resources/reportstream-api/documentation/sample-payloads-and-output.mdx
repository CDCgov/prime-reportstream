...
<LayoutMain>
  ...
  [{site.assets.standardCsv.path} className="usa-button"](Download a sample file <Icon name="FileDownload" />)
  ...
  [{site.assets.exampleHl7.path} download className="usa-button"](Download a sample file <Icon name="FileDownload" />)

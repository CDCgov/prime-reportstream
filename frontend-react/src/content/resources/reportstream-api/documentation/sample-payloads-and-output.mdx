...
<a href={site.assets.standardCsv.path} className="usa-button">Download a sample file <Icon.FileDownload /></a>
...
<a href={site.assets.exampleHl7.path} download className="usa-button">Download a sample file <Icon.FileDownload /></a>

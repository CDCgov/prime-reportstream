...
subtitle: By using the ReportStream Restful (REST) API, your data will automatically be filtered, transformed, batched, and forwarded to public health departments.
---
...
export const handleClick = () => {
    trackAppInsightEvent(frontmatter.title, {});
...
<LayoutMain>
    ...
    ***
    ...
    ## ["#onboarding-overview" className="usa-link usa-link--unstyled"](Onboarding overview)
    ...
    ***
    ...
    ## ["#about-our-api" className="usa-link usa-link--unstyled"](About our API)

...
<div className="usa-alert usa-alert--info margin-bottom-6 measure-6">
    <div className="usa-alert__body">
        ...
        <p className="usa-alert__text">
            ...
            [{`mailto: ${site.orgs.RS.email}`}](reportstream@cdc.gov)
        </p>
    </div>
</div>
...
<ol className="usa-process-list rs-process-list__documentation">
    ...
    <li className="usa-process-list__item">
        ...
        <div className="margin-top-2">
            <p>
                Go to{" "}
                ["/login"](https://reportstream.cdc.gov/login)
...
[{`mailto: ${site.orgs.RS.email}`}](contact us)
.
...
[{`${site.orgs.RS.url}/login`}]({`${site.orgs.RS.url}/login`})
.

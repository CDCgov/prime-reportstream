...
- <b>Patient data (as needed):</b> If required, ReportStream 
can also send patient data. In some cases, there may not be 
a testing facility that is registered with ReportStream in your 
jurisdiction. In this case, we'll finish all of the possible 
steps on your side. Once a testing facility registers we'll

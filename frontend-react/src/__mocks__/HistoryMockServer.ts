...
const handlers = [
    ...
    rest.get(
        `${process.env.REACT_APP_BACKEND_URL}${listEndpoint.url}`,
        (req, res, ctx) => {
    ...
    rest.get(
        `${process.env.REACT_APP_BACKEND_URL}${detailFail.url}/fail`,
        (req, res, ctx) => {
    ...
    rest.get(
        `${process.env.REACT_APP_BACKEND_URL}${detailSuccess.url}`,
        (req, res, ctx) => {
    ...
    rest.get(
        `${process.env.REACT_APP_BACKEND_URL}${detailFail.url}`,
        (req, res, ctx) => {
            return res(ctx.status(404));
        }
    ),

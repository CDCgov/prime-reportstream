    ...
    return (
        <>
            <section id="anchor-top">
                ...
                <p className="usa-intro">If you’re a public health department and want to connect ReportStream through Electronic Lab Reporting (ELR), you’ll need to fill out the ReportStream ELR onboarding form.</p>
                <p className="usa-intro">Our checklist here provides a preview of what we’ll ask, so you can gather everything you need to complete the form.</p>
            ...
            <section>
                ...
                <h3 id="alternate-contact-information">Program or admin staff contact information</h3>
                ...
                <ul>
                    <li><span className="text-bold">File type:</span> (HL7 v2.5.1, CSV, or other) </li>
                    <li><span className="text-bold">Transport method:</span> (SFTP, VPN, Health Information Exchange, SOAP, PHINMS, or other) </li>
                    <li><span className="text-bold">Batching:</span> Do you want HL7 message batching <a href="https://www.lyniate.com/knowledge-hub/hl7-batch-file-protocol/">using FHS and BHS segments</a>? </li>
                    <li><span className="text-bold">Timing:</span> Do you want real time or daily reports, and at what time of day? </li>
                    <li><span className="text-bold">“Ask on Order Entry”:</span> Do you want “Ask on Order Entry” questions as <a href="https://hl7-definition.caristix.com/v2/HL7v2.5/Segments/OBX">OBX fields</a>? </li>
                    <li><span className="text-bold">Test data:</span> Do you require synthetic and/or real patient data before going live? </li>
                    <li><span className="text-bold">Local public health department reporting:</span> Explain any local public health department reporting requirements that are different from the state. </li>
                    <li><span className="text-bold">Third-party information services:</span> Do you require your data to be routed through a third-party like a Health Information Exchange or a health information integration service? </li>
                    <li><span className="text-bold">Additional fields:</span> Any other data or fields you’d like collected? </li>
                </ul>
                ...
                <ul>
                    ...
                    <li><span className="text-bold">Custom data fields:</span> Do you require information in addition to standard fields (name, CLIA number and/or address)? </li>
                    <li><span className="text-bold">Custom registration process:</span> Do you have a custom testing facility registration process? </li>
                </ul>

                <h3 id="hl7-data-fields">HL7 data fields (Not applicable if using an alternate data format) </h3>

                <ul>
                    <li>Receiving application name </li>
                    <li>Receiving application <a href="https://www.hl7.org/oid/">OID</a></li>
                    <li>Receiving facility name </li>
                    <li>Receiving facility <a href="https://www.hl7.org/oid/">OID</a></li>
                </ul>
                ...
                <ul>
                    <li><span className="text-bold">Required documentation:</span> Necessary registration or data use, or legal agreements, etc. that you need ReportStream to complete</li>
                    <li><span className="text-bold">Sample files:</span> Sample files of your required data formatting, rules or regulations, etc. that would be helpful to review </li>
                </ul>
            </section>
            <hr className="margin-y-6" />
            <section>

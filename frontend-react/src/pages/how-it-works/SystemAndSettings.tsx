...
export const SystemAndSettings = () => {
    return (
        <>
            <Helmet>
                <title>
                    Systems and Settings | How it works |{" "}
            ...
            <section id="anchor-top">
                ...
                <ul>
                    <li>
                        <a
                            href="#data-security-and-storage"
                            className="usa-link"
                        >
                    ...
                    <li>
                        <a
                            href="#data-transport-and-sending"
                            className="usa-link"
                        >
            ...
            <section className="margin-top-6 padding-top-2 border-top border-base-lighter">
                ...
                <h2 id="data-configuration-and-formatting">
                    Data configuration and formatting
                </h2>
                ...
                <h2 id="data-transport-and-sending">
                    Data transport and sending
                </h2>

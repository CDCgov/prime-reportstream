    ...
    return (
        <>
            <section id="anchor-top">
                ...
                <p className="usa-intro">Learn more about the ReportStream system and how to set up and use our tool.</p>
            ...
            <section>
                ...
                <h2 id="data-transport-and-sending">Data transport and sending</h2>
                ...
                <p>Once state public health departments join ReportStream you’ll get data about all patients who are residents of that state. You’ll also get data from testing facilities connected to ReportStream that are located in that state.</p>

                <p>ReportStream can also send data to county, city, local, territorial, and tribal public health departments, based on state data access rules and regulations.</p>

        ...
        <>
            ...
            <main>
                <article>
                    ...
                    <p>Please update your browser or use one of the following:</p>
                    <ul>
                        <li>
                            <USExtLink href="https://www.google.com/chrome/">Google Chrome</USExtLink>
                        </li>
                        <li>
                            <USExtLink href="https://www.mozilla.org/en-US/firefox/new/">Mozilla Firefox</USExtLink>
                        </li>
                        <li>
                            <USExtLink href="https://www.apple.com/safari/">Apple Safari</USExtLink>
                        </li>
                        <li>
                            <USExtLink href="https://www.microsoft.com/en-us/edge">Microsoft Edge</USExtLink>
                        </li>
                    </ul>
                    <p>

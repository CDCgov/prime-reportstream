                ...
                <div className="grid-row grid-gap">
                    <div className="tablet:grid-col-8 usa-prose">
                        <section>
                            ...
                            <p>
                                ReportStream was developed by the CDC for
                                COVID-19 test data reporting and is 100% free.
                            </p>
                            ...
                            <h2 className="margin-top-4">
                                Which browser is recommended for using
                                ReportStream?
                            </h2>
                            <p>
                                Our application works best on a modern desktop
                                browser (ex:{" "}
                                <a
                                ...
                                ). ReportStream doesn't support Internet
                                Explorer 11 or below.
                            </p>

                            <h2 className="margin-top-4">
                                I just activated my ReportStream account, why
                                can't I log in?{" "}
                            </h2>
                            <p>
                                ...
                                >
                                    Pandemic-Ready Interoperability
                                    Modernization Effort (PRIME)
                                </a>
                                , shares some resources with other projects
                                operated by the CDC.
                            </p>
                            <p>
                                Some aspects of the registration process may
                                ...
                                collaborates with. To access your user account,
                            ...
                            <p>
                                ...
                                <a className="usa-link" href="/contact">
                                    contact us
                                </a>
                                .
                            </p>
                            ...
                            <h2 className="margin-top-4">
                                Why does my CSV file keep getting errors from
                                ReportStream?{" "}
                            </h2>
                            <p>
                                We've put together{" "}
                                ...
                                outlining how to prepare a CSV file for
                                submission. We use a{" "}
                                <a
                                    className="usa-link"
                                ...
                                that will be accepted by state, tribal, local,
                                or territorial (STLT) health departments
                                partnered with ReportStream. The most common
                                errors are outlined below:
                            </p>
                            <h3>Incorrect values</h3>
                            <p>
                                Elements of our standard CSV schema may require
                                specific values or formatting. Common values you
                                may be experiencing errors with include:{" "}
                                <a
                                    className="usa-link"
                            ...
                            <p>
                                ...
                                requires certain fields to be filled out.
                                Required fields containing blank values can
                                prevent your file from being uploaded. For a
                                list of required fields, read our{" "}
                                <a
                                    className="usa-link"
                                    href="/getting-started/testing-facilities/csv-schema"
                                >
                            ...
                            <h2 className="margin-top-4">
                                Can I sort my CSV columns in any order when I
                                submit the file to ReportStream?{" "}
                            </h2>
                            <p>
                                Yes, you can organize your CSV columns in any
                                order within your file. ReportStream looks for
                                data values beneath the column header regardless
                                of where it's located in the file.
                            </p>

                            <h2 className="margin-top-4">
                                What's the difference between ReportStream and
                                SimpleReport?{" "}
                            </h2>
                            <p>
                                ReportStream and{" "}
                            ...
                            <p>
                                ReportStream is an open source, cloud based
                                platform that aggregates COVID-19 test results
                                from healthcare clinics, hospitals,
                                laboratories, and other organizations, and
                                delivers them to public health departments.
                            </p>
                            <p>
                                SimpleReport is a cloud-based application that
                                helps organizations to collect and submit
                                COVID-19 test results to public health. Data
                                submitted with SimpleReport is routed through
                                ReportStream and delivered to public health
                                departments.
                            </p>
                        </section>
                    </div>

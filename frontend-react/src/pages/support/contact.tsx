                ...
                <div className="grid-row grid-gap">
                    <div className="tablet:grid-col-8 usa-prose">
                        <section>
                            ...
                            <h2>Interested in partnering with ReportStream?</h2>
                            ...
                            <h2 className="margin-top-4">Have a problem with a data you're trying to send or receive?</h2>
                            <p>Read our guides for sending data <a className="usa-link" href="/getting-started/public-health-departments/elr-checklist">via API (ELR)</a> or <a className="usa-link" href="/getting-started/testing-facilities/csv-upload-guide">via CSV upload</a>. For all other issues, contact us at <a href={"mailto:" + DOMPurify.sanitize(site.orgs.RS.email)} className="usa-link">{site.orgs.RS.email}</a>.</p>
            
                            <h2 className="margin-top-4">Need something else?</h2>
                            <p>For quick answers to common questions, read our <a className="usa-link" href="/support/faq">frequently asked questions</a>.</p>
                            <p>If you have another question, issue, or bug to report, we're happy to help. Email us at <a href={"mailto:" + DOMPurify.sanitize(site.orgs.RS.email)} className="usa-link">{site.orgs.RS.email}</a>.</p>                           
                        </section>
                    </div>
                </div>
            </section>

                    ...
                    <div className="tablet:grid-col-8 usa-prose">
                        <section>
                            ...
                            <h2 className="usa-intro text-base">
                                Want to get in touch with ReportStream? Email us
                                at{" "}
                                <a
                                    href={
                                        "mailto:" +
                            ...
                            <p>
                                To learn more, or to begin the account
                                registration process, email us at{" "}
                                <a
                                    href={
                                        "mailto:" +
                                        DOMPurify.sanitize(site.orgs.RS.email)
                            ...
                            <h2 className="margin-top-4">
                                Have a problem with a data you're trying to send
                                or receive?
                            </h2>
                            <p>
                            ...
                            <p>
                                If you have another question, issue, or bug to
                                report, we're happy to help. Email us at{" "}
                                <a
                                    href={
                                        "mailto:" +
                                        DOMPurify.sanitize(site.orgs.RS.email)

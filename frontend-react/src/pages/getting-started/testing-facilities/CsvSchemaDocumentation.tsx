                    ...
                    >
                        {field.sections?.map((section, sectionIndex) => {
                            return (
                                ...
                                >
                                    <h3 className="font-body-lg margin-y-1">
                                        {section.title}
                                    </h3>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    {item.required ? (
                                                        ...
                                                        <span className="text-normal bg-white border-1px border-base font-body-3xs padding-x-1 padding-y-05 text-base margin-left-2">
                                                            Optional
                                                        </span>
                                                    )}
                                                </h4>

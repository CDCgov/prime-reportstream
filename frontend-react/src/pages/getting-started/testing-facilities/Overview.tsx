    ...
    return (
        <>
            ...
            <section id="anchor-top">
                ...
                <p>
                    [VIA ELR or CSV UPLOAD]. Currently, ReportStream can accept
                    either a comma-separated values (CSV) file or Health Level 7
                    (HL7) input data format.
                </p>
                <h3>What’s the Difference Between CSV and HL7?</h3>
                <p>
                    HL7 is the data format underlying Electronic Lab Reporting
                    (ELR). HL7 is a set of international standards for transfer
                    of clinical and administrative data between software
                    applications used by various healthcare providers.
                </p>
                <p>
                    CSV is a delimited text file that uses a comma to separate
                    values. Each line of the file is a data record. Each record

    ...
    return (
        <>
            <section className="grid-container margin-top-5" id="anchor-top">
                ...
                <p>
                    Entity: A health care provider or facility; testing site;
                    state, local, tribal, and territorial public health
                    authorities (STLT Public Health Agencies); or other
                    organization that is enrolled in and using ReportStream to
                    transmit and/or receive ReportStream Data.
                </p>

                <p>
                    User: Individual authorized to act on behalf of the Entity
                    under these Terms. ReportStream will only designate one User
                    from the Entity as the Administrator. Administrators will
                    have more detailed identity verification than general Entity
                    Users. Once the Administrator has their identity verified,
                    the Administrator can add other general Entity Users to the
                    Application. Both roles are referred to as “User” for the
                    purposes of these Terms.
                </p>

                <p>
                    ReportStream Data: Electronic public health information
                    transmitted using the PRIME ReportStream infrastructure,
                    including but not limited to all optional and required
                    notifiable and reportable public health disease information
                    as well as information required in a public health
                    emergency, such as hospitalizations related to a particular
                    disease, supply of personal protective equipment, etc.
                </p>

                <h2>Scope</h2>

                <p>
                    PRIME ReportStream works with state and local public health
                    departments to enable the exchange of public health
                    information including personally identifiable information
                    (PII) for authorized public health activities. PRIME
                    ReportStream is being provided by HHS and CDC to enable a
                    User to send ReportStream Data to STLT Public Health
                    Agencies in furtherance of public health response activities
                    related to COVID-19. Use of PRIME ReportStream is subject to
            ...
            <section className="grid-container margin-top-5">
                ...
                <p>
                    In order to access PRIME ReportStream, as part of the
                    registration process for PRIME ReportStream, and for your
                    continued use of PRIME ReportStream, you may be required to
                    provide certain information (such as identification or
                    contact details). Any such registration information you give
                    to CDC or HHS must be accurate and up-to-date, and you must
                ...
                <p>
                    *For Administrators*: The Administrator agrees to verify
                    identity of other Entity Users who are added and to
                    inactivate any other Entity Users who should no longer have
                    access. The Administrator also agrees to set permissions
                    appropriately to determine the minimum access necessary for
                    each other Entity User to complete their required job
                    duties.
                </p>

                <p>
                    *For all Users*: As noted above, Entity Users, both
                    Administrators and other Entity Users, agree to accept and
                    comply with these Terms once you register and use PRIME
                    ReportStream.
                </p>
                ...
                <p>
                    ...
                    retrieve, view and otherwise ‘get’ information from data you
                    are sending via PRIME ReportStream and the Platform. Please
                    note that the data which you are sending via PRIME
                ...
                <p>
                    PRIME ReportStream is being provided in order to allow for
                    the transmission of relevant data to STLT Public Health
                    ...
                    ReportStream Data for the purposes of public health
                    reporting and does not intend to take custody or control of
                    ReportStream Data. The User acknowledges and agrees that CDC
                    may address gaps in the ReportStream Data during the
                    transmission process, for the limited purpose of addressing
                    data quality issues. Except as may be required by applicable
                    federal law, CDC may not use or disclose the ReportStream
                    Data for other purposes than described in these Terms of
                    Service. As noted, generally, CDC does not intend to take
                    custody or control of the ReportStream Data; where the data
                    is not in CDC's custody and control and the ReportStream
                    Data is requested of CDC, CDC shall notify the requestor
                    that CDC does not have custody of this data and refer
                    requestor to the Entity.
                </p>

                <h3>Sharing of data</h3>

                <p>
                    Data recorded and stored in PRIME ReportStream is for use by
                    the User as needed for authorized public health activities,
                    including transmission of public health data for reporting
                    purposes. To meet applicable reporting requirements,
                    ReportStream Data will be made available to the appropriate
                    STLT Public Health Agency based on location, with all
                    relevant fields including but not limited to: case
                    reporting, lab results, hospitalizations, and vaccine
                    administration.
                </p>

                <p>
                    By entering information that is being reported to STLT
                    Public Health Agency, the User attests that it is authorized
                    to report the data using PRIME ReportStream. Users, either
                    directly or in coordination with the relevant STLT Public
                    Health Agency, may decide to use PRIME ReportStream to send
                    de-identified or other appropriate and/or agreed upon levels
                    of data to CDC for public health purposes; such data sent to
                    CDC will be maintained consistent with applicable federal
                    laws.
                </p>
            ...
            <section className="grid-container margin-top-5">
                ...
                <p>
                    While using PRIME ReportStream, certain general data
                    analytics on the usage patterns and performance of
                    ReportStream may be gathered and stored automatically to
                    assist with design and development of PRIME ReportStream.
                    This general usage data is not linked to an individual’s
                    identity but IP address and device information may be
                    included. Transactions are audited and stored for system
                    monitoring, performance, and troubleshooting purposes and
                    may be tied to the user performing an activity. Any such
                    data will be maintained consistent with applicable federal
                    laws.
                </p>

        ...
        <>
            <section className="grid-container margin-top-5" id="anchor-top">
                ...
                >
                    ...
                    <p>
                        ...
                        use of this system may result in disciplinary action, as
                    ...
                    <ul>
                        <li>
                            ...
                            regarding any communication or data transiting or
                            stored on this information system.
                        </li>
                        <li>
                            At any time, and for any lawful government purpose,
                            the government may monitor, intercept, and search
                            and seize any communication or data transiting or
                            stored on this information system.
                        </li>
                        <li>
                            Any communication or data transiting or stored on
                            this information system may be disclosed or used for
                ...
                <p>
                    <strong>Public Health Data:</strong> Electronic public
                    health information transmitted using the PRIME ReportStream
                    infrastructure, including but not limited to reportable
                    public health data as well as information relevant in a
                    public health emergency, such as hospitalizations related to
                    a particular disease, supply of personal protective
                    equipment, etc.
                </p>

                <p>
                    <strong>Entity:</strong> A health care provider or facility;
                    testing site; state, local, tribal, or territorial public
                    health authority (STLT Public Health Agency); or other
                    organization that is enrolled in and using ReportStream to
                    transmit and/or receive Public Health Data.
                </p>

                <p>
                    <strong>User:</strong> Individual authorized to act on
                    behalf of the Entity under these Terms. ReportStream will
                    only designate one User from the Entity as the
                    Administrator. Administrators will have more detailed
                    identity verification than general Entity Users. Once the
                    Administrator has their identity verified, the Administrator
                    can add other general Entity Users to the Application. Both
                    roles are referred to as “User” for the purposes of these
                    Terms.
                </p>
                ...
                <p>
                    PRIME ReportStream is provided by HHS and CDC to enable a
                    User to send Public Health Data, including personally
                    identifiable information (PII), to STLT Public Health
                    Agencies in furtherance of authorized public health response
                    activities related to COVID-19. Use of PRIME ReportStream is
                    subject to these Terms of Service and use of PRIME
            ...
            <section>
                ...
                <p>
                    ...
                    that Entity to the Terms and by accepting the Terms, you are
                    doing so on behalf of that Entity (and all references to
                    “you” in the Terms refer to you and that Entity).
                </p>

                <p>
                    You may be required to provide certain information (such as
                    identification or contact details) to access PRIME
                    ReportStream, as part of the registration process for PRIME
                    ReportStream, and for your continued use of PRIME
                    ReportStream. Any such registration information you give to
                    CDC or HHS must be accurate and up-to-date, and you must
                    inform us promptly of any updates so that we can keep you
                    informed of any changes to PRIME ReportStream or these Terms
                    which may impact your usage of PRIME ReportStream. Upon
                    registration and the creation of User accounts within PRIME
                    ReportStream, credentials (such as passwords, keys, tokens,
                    and User identifications (IDs)) will be issued to you by
                    CDC. These credentials are intended to be used only by you
                    and to identify any software or APIs which you are using.
                    You agree to keep your credentials confidential and make
                    reasonable efforts to prevent and discourage other persons
                    from using your credentials.
                </p>

                <p>
                    <strong>For Administrators:</strong> The Administrator
                    agrees to verify identity of other Entity Users who are
                    added and to inactivate any other Entity Users who should no
                    longer have access. The Administrator also agrees to set
                    permissions appropriately to determine the minimum access
                    necessary for each other Entity User to complete their
                    required job duties.
                </p>

                <p>
                    <strong>For all Users:</strong> As noted above, Entity
                    Users, both Administrators and other Entity Users, agree to
                    accept and comply with these Terms once you register and use
                    PRIME ReportStream.
                </p>
                ...
                <p>
                    Please note that the data which you are sending via PRIME
                    ReportStream may be subject to the Privacy Act of 1974, the
                    Health Insurance Portability and Accountability Act of 1996
                    (HIPAA), and other laws, and may require special
                    safeguarding. By accessing and using PRIME ReportStream, you
                    agree to strictly abide by all applicable federal and state
                    laws regarding the collection, use, confidentiality,
                    protection, and disclosure of information obtained or sent
                    through PRIME ReportStream. If you would like more
                    information about the application of the Privacy Act at
                    CDC, 
                    <a
                ...
                <p>
                    For purposes of use of PRIME ReportStream, if you are a
                    HIPAA-covered entity or acting on behalf of one as a
                    business associate or if the data is maintained in a
                    HIPAA-covered designated record set, you further acknowledge
                    that you will abide by applicable HIPAA regulations (45 CFR
                    Parts 160 and 164) for purposes of appropriate storage,
                    transmission, use and disclosure of any protected health
                    information.
                </p>
                ...
                <p>
                    PRIME ReportStream is being provided to allow for the
                    transmission of Public Health Data to STLT Public Health
                    Agencies to facilitate authorized public health activities.
                    HHS and CDC acknowledge that CDC, through PRIME
                    ReportStream, is acting as a conduit for transmission of
                    Public Health Data to STLT Public Health Agencies for the
                    purposes of public health reporting and does not intend to
                    take custody or control of those data. Where the Public
                    Health Data is not in CDC's custody and control and the
                    Public Health Data is requested of CDC, CDC shall notify the
                    requestor that CDC does not have custody of this data and
                    refer requestor to the Entity.
                </p>

                <p>
                    The User acknowledges and agrees that CDC may address gaps
                    in the Public Health Data during the transmission process,
                    for the limited purpose of addressing data quality and
                    completeness issues as appropriate. Except as may be
                    required by applicable federal law, CDC may not use or
                    disclose the Public Health Data for other purposes than
                    described in these Terms of Service.
                </p>

                <p>
                    You may use PRIME ReportStream to search, display, analyze,
                    retrieve, view and otherwise ‘get’ transactional data from
                    transmissions you are sending or receiving via PRIME
                    ReportStream. PRIME ReportStream may also be used to
                    facilitate entities sending Public Health Data directly to
                    CDC for agreed upon purposes. In those circumstances, Entity
                    acknowledges that such Public Health data sent directly to
                    CDC for those agreed upon purposes will be subject to
                    applicable federal law once in CDC's custody and control.
                </p>

                <h3>Sharing of data</h3>

                <p>
                    Public Health Data sent through PRIME ReportStream is for
                    use by the User as needed for authorized public health
                    activities, including transmission of Public Health Data for
                    reporting purposes. To meet applicable reporting
                    requirements, Public Health Data will be made available to
                    the appropriate STLT Public Health Agencies.
                </p>

                <p>
                    By entering information that is being reported to one or
                    more STLT Public Health Agencies, the User attests that it
                    is authorized to report those data using PRIME ReportStream.
                    Users, either directly or in coordination with the relevant
                    STLT Public Health Agency, may decide to use PRIME
                    ReportStream to send de-identified or other appropriate
                    and/or agreed upon levels of data to CDC for public health
            ...
            <section>
                ...
                <p>
                    ...
                    general usage patterns and performance of ReportStream to
                    assist with design and development of PRIME ReportStream.
                    This transactional and usage characteristic data is not
                    linked to an individual’s identity, but IP address and
                    device information may be included. Transactional data are
                    audited and stored for system monitoring, performance, and
                    troubleshooting purposes and may be tied to the user
                    performing an activity. Any such data will be maintained
                    consistent with applicable federal laws.
                </p>

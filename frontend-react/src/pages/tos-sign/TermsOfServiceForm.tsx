...
function TermsOfServiceForm() {
    ...
    return success ?
        ...
        (
            <>
                <Helmet>
                    <title>Sign the Terms of Service | {process.env.REACT_APP_TITLE}</title>
                </Helmet>
                <div data-testid="form-container" className="grid-container tablet:grid-col-6 margin-x-auto">
                    <Title

...
test.describe("Submission history page", () => {
    ...
    test.describe("admin user", () => {
        ...
        test.describe("with org selected", () => {
            test.beforeEach(async ({ page }) => {
                ...
                await submissionHistory.mockGetSubmissionsResponse(page, TEST_ORG_IGNORE);
            ...
            test.describe("table", () => {
                ...
                test("table column 'ReportId' will open the report details", async ({ page }) => {
                ...
                test("table column 'Date/time submitted' has expected data", async ({ page }) => {
                    expect(await tableDataCellValue(page, 0, 1)).toEqual("3/7/2024, 6:00:22 PM");
                });

                test("table column 'File' has expected data", async ({ page }) => {
                    expect(await tableDataCellValue(page, 0, 2)).toEqual("myfile.hl7");
    ...
    test.describe("receiver user", () => {
        ...
        test("nav does not contain the Submissions option", async ({ page }) => {
            const navItems = page.locator(".usa-nav  li");

export const MOCK_GET_RECEIVERS_IGNORE = [
    ...
    },
    {
        ...
        jurisdictionalFilter: [
            "matches(ordering_facility_state, IG)",
            "matches(ordering_facility_county, EVERY_5_MINS)",
        ],
        qualityFilter: [],
        routingFilter: [],
        processingModeFilter: [],
    ...
    },
    {
        ...
        jurisdictionalFilter: [
            "matches(ordering_facility_state, IG)",
            "matches(ordering_facility_county, EVERY_15_MINS)",
        ],
        qualityFilter: [],
        routingFilter: [],
        processingModeFilter: [],
...
export const MOCK_GET_ORGANIZATION_IGNORE = {
    ...
    filters: [
        ...
        },
        {
            topic: "mars-otc-elr",
            jurisdictionalFilter: [
                "Bundle.entry.resource.ofType(Patient).address.state.exists() and Bundle.entry.resource.ofType(Patient).address.state = 'IG'",
            ],
            qualityFilter: null,
            routingFilter: null,
            processingModeFilter: null,
